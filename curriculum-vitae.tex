...
\section{Expériences professionnelles}
  ...
  \cventry{2023/2024}{FullStack Web Developper Ruby on Rails}{The Packengers}{Remote}{}{
    Ruby on Rails, PostGreSQL, MiniTest, Active Admin, Stimulus, Turbo, Github, Heroku
    \begin{itemize}%
    \item Passage de l'api Octobat à Sellsy
  ...
  \cventry{2022}{FullStack Web Developper Ruby on Rails}{Freelance}{Remote}{}{
    ...
    \item Développement d'une API REST pour Vera App
    \newline{}
    \end{itemize}
  }
