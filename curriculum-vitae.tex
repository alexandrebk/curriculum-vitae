...
\section{Expériences professionnelles}
  ...
  \cventry{Janvier 2022\\à Aujourd'hui}{FullStack Web Developper Freelance}{Korium}{Paris}{}{
    Ruby on Rails, RSpec, Stimulus, Github, Heroku, Scalingo, Notion \newline{}
    API utilisé: Salesforce, Twillio, Airtable
    \begin{itemize}%
    \item Maintenance www.mon-cdi.fr
    \item Maintenance www.studio-paillette.fr
